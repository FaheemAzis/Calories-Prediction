...
# Assigning Continents to Countries
data['Continent'] = ""
...
# Handling Missing Continent Values
...
# Scaling Input Percentages to 25%
...
# Identifying Maximum and Minimum Contributors to Diet
